...
class CredDefValuePrimarySchema(OpenAPISchema):
    ...
    n = fields.Str(metadata={**NUM_STR_WHOLE})
    s = fields.Str(metadata={**NUM_STR_WHOLE})
    r = fields.Nested(
        Schema.from_dict(
            {
                "master_secret": fields.Str(metadata={**NUM_STR_WHOLE}),
                "number": fields.Str(metadata={**NUM_STR_WHOLE}),
                "remainder": fields.Str(metadata={**NUM_STR_WHOLE}),
            }
        ),
        metadata={"name": "CredDefValuePrimaryRSchema"},
    )
    rctxt = fields.Str(metadata={**NUM_STR_WHOLE})
    z = fields.Str(metadata={**NUM_STR_WHOLE})
