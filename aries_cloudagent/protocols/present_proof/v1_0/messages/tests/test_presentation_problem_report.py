...
class TestPresentationProblemReport(TestCase):
    ...
    @mock.patch(
        f"{PROTOCOL_PACKAGE}.messages.presentation_problem_report.PresentationProblemReportSchema.load"
    )
    ...
    @mock.patch(
        f"{PROTOCOL_PACKAGE}.messages.presentation_problem_report.PresentationProblemReportSchema.dump"
    )
